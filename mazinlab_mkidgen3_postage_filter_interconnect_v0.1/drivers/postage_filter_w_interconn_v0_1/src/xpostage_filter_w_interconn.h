...
// ==============================================================
#ifndef XPOSTAGE_FILTER_W_INTERCONN_H
#define XPOSTAGE_FILTER_W_INTERCONN_H
...
#include <stddef.h>
#endif
#include "xpostage_filter_w_interconn_hw.h"
...
} XPostage_filter_w_interconn_Config;
#endif

typedef struct {
    u64 Control_BaseAddress;
    u32 IsReady;
} XPostage_filter_w_interconn;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XPostage_filter_w_interconn_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XPostage_filter_w_interconn_ReadReg(BaseAddress, RegOffset) \
