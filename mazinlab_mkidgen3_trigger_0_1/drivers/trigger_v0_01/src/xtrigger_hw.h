...
#define XTRIGGER_CONTROL_ADDR_AP_CTRL         0x0000
#define XTRIGGER_CONTROL_ADDR_GIE             0x0004
#define XTRIGGER_CONTROL_ADDR_IER             0x0008
#define XTRIGGER_CONTROL_ADDR_ISR             0x000c
