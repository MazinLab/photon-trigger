...
void XPhoton_trigger_Set_dropped_i(XPhoton_trigger *InstancePtr, u32 Data) {
    ...
    XPhoton_trigger_WriteReg(InstancePtr->Control_BaseAddress, XPHOTON_TRIGGER_CONTROL_ADDR_DROPPED_I_DATA, Data);
}
...
u32 XPhoton_trigger_Get_dropped_i(XPhoton_trigger *InstancePtr) {
    ...
    Data = XPhoton_trigger_ReadReg(InstancePtr->Control_BaseAddress, XPHOTON_TRIGGER_CONTROL_ADDR_DROPPED_I_DATA);
    return Data;
}
...
u32 XPhoton_trigger_Get_dropped_o(XPhoton_trigger *InstancePtr) {
    ...
    Data = XPhoton_trigger_ReadReg(InstancePtr->Control_BaseAddress, XPHOTON_TRIGGER_CONTROL_ADDR_DROPPED_O_DATA);
    return Data;
}
...
u32 XPhoton_trigger_Get_dropped_o_vld(XPhoton_trigger *InstancePtr) {
    ...
    Data = XPhoton_trigger_ReadReg(InstancePtr->Control_BaseAddress, XPHOTON_TRIGGER_CONTROL_ADDR_DROPPED_O_CTRL);
    return Data & 0x1;
}
