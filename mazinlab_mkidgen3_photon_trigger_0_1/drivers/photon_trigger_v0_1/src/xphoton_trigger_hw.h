...
#define XPHOTON_TRIGGER_CONTROL_ADDR_DROPPED_I_DATA                0x1418
#define XPHOTON_TRIGGER_CONTROL_BITS_DROPPED_I_DATA                32
#define XPHOTON_TRIGGER_CONTROL_ADDR_DROPPED_O_DATA                0x1420
#define XPHOTON_TRIGGER_CONTROL_BITS_DROPPED_O_DATA                32
#define XPHOTON_TRIGGER_CONTROL_ADDR_DROPPED_O_CTRL                0x1424
