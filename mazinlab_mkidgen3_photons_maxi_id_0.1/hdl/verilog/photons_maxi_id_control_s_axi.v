...
// ==============================================================
`timescale 1ns/1ps
module photons_maxi_id_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER                  = 6'h08,
    ADDR_ISR                  = 6'h0c,
    ADDR_PHOTONS_OUT_DATA_0   = 6'h10,
    ADDR_PHOTONS_OUT_DATA_1   = 6'h14,
    ADDR_PHOTONS_OUT_CTRL     = 6'h18,
    ADDR_ACTIVE_BUFFER_DATA_0 = 6'h28,
    ADDR_ACTIVE_BUFFER_CTRL   = 6'h2c,
    ADDR_N_PHOTONS_BASE       = 6'h20,
    ADDR_N_PHOTONS_HIGH       = 6'h27,
    WRIDLE                    = 2'd0,
    WRDATA                    = 2'd1,
    WRRESP                    = 2'd2,
    WRRESET                   = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [0:0]                    int_n_photons_shift0;

//------------------------Instantiation------------------
// int_n_photons
photons_maxi_id_control_s_axi_ram #(
    .MEM_STYLE ( "auto" ),
    .MEM_TYPE  ( "S2P" ),
    .BYTES     ( 4 ),
    .DEPTH     ( 2 )
...
//------------------------Memory logic-------------------
// n_photons
assign int_n_photons_address0 = n_photons_address0 >> 1;
assign int_n_photons_ce0      = n_photons_ce0;
assign int_n_photons_be0      = {2{n_photons_we0}} << (n_photons_address0[0] * 2);
assign int_n_photons_d0       = {2{3'd0, n_photons_d0}};
...
// int_n_photons_shift0
always @(posedge ACLK) begin
    if (ARESET)
        int_n_photons_shift0 <= 1'b0;
    else if (ACLK_EN) begin
        if (n_photons_ce0)
            int_n_photons_shift0 <= n_photons_address0[0];
    end
end
...
module photons_maxi_id_control_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
